...
export const GoogleIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" {...props}>
        ...
        <path fill="#34A853" d="M43.611 20.083H24v8h11.303c-1.649 4.657-6.08 8-11.303 8V44c5.268 0 10.046-1.947 13.611-5.657c3.429-3.553 5.389-8.341 5.389-13.611c0-1.341-.138-2.65-.389-3.917z"/>
        <path fill="#FBBC05" d="M9.961 28.039c-1.032-1.897-1.611-4.076-1.611-6.399s.579-4.502 1.611-6.399l-5.657-5.657C2.135 13.176 1 18.341 1 24c0 5.659 1.135 10.824 4.304 15.291l5.657-5.252z"/>
        <path fill="#EA4335" d="M24 44c5.166 0 9.86-1.977 13.291-5.291l-5.657-5.657c-1.749 1.341-3.991 2.252-6.634 2.252c-4.932 0-9.15-2.985-10.74-7.252l-5.657 5.252C13.176 41.865 18.341 44 24 44z"/>
...
export const NetworkIntelligenceIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    ...
    <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 6a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0zM12 12.75h.008v.008H12v-.008z" />
  </svg>
);

export const CopyIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 17.25v3.375c0 .621-.504 1.125-1.125 1.125h-9.75a1.125 1.125 0 01-1.125-1.125V7.875c0-.621.504-1.125 1.125-1.125H6.75a9.06 9.06 0 011.5.124m7.5 10.376h3.375c.621 0 1.125-.504 1.125-1.125V11.25c0-4.46-3.243-8.161-7.5-8.876a9.06 9.06 0 00-1.5-.124H9.375c-.621 0-1.125.504-1.125 1.125v3.5m7.5 10.375H9.375a1.125 1.125 0 01-1.125-1.125v-9.25m9.375 0V9.375c0-.621-.504-1.125-1.125-1.125H1.875a1.125 1.125 0 01-1.125-1.125V5.25c0-.621.504-1.125 1.125-1.125h5.25c.621 0 1.125.504 1.125 1.125v2.25" />
  </svg>
);
...
export const InboxIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 13.5h3.86a2.25 2.25 0 012.012 1.244l.256.512a2.25 2.25 0 002.013 1.244h3.218a2.25 2.25 0 002.013-1.244l.256-.512a2.25 2.25 0 012.013-1.244h3.859M12 3v13.5m0 0L8.25 12m3.75 4.5L15.75 12" />
  </svg>
);
